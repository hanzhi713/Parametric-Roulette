...
<img src="http://latex.codecogs.com/svg.latex?&space;B'(f(t_2)\&space;&plus;\&space;\textup{sgn(n)}\&space;r&space;\cos(\arctan(n)),\&space;g(t_2)\&space;&plus;\&space;\textup{sgn(n)}\&space;r&space;\sin(\arctan(n)))" title=" B'(f(t_2)\ +\ \textup{sgn(n)}\ r \cos(\arctan(n)),\ g(t_2)\ +\ \textup{sgn(n)}\ r \sin(\arctan(n)))" />
